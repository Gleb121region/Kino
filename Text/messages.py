add_to_favorites_text = 'Добавить в избранное'
...
sorry_film_did_not_fild_text = 'К сожалению, по вашему запросу ничего не было найдено. Скорее всего, вы указали неверное название фильма.'
sorry_film_title_wrong_text = 'По вашему запросу не удалось найти кинопроизведение, название указано не корректно'
